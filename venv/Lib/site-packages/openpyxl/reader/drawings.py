...
def find_images(archive, path):
    """
    Given the path to a drawing file extract charts and media
    ...
    try:
        ...
        warn("DrawingML support is incomplete and limited to charts and media only. Shapes and drawings will be lost.")
        return [], []
    ...
    images = []
    if not PILImage: # Pillow not installed, drop media
